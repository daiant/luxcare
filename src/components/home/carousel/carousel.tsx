    ...
    <div className={styles.carousel} onMouseDown={handleMouseDown} ref={slider}>
      <div className={styles.item}>
        <div className={styles.img_wrapper}>
          <img draggable="false" alt="crown" src={fetchImage('/images/home/destino/destino_01.webp')} />
        </div>
      ...
      <div className={styles.item}>
        <div className={styles.img_wrapper}>
          <img draggable="false" alt="vector" src={fetchImage('/images/home/destino/destino_02.webp')} />
        </div>
      ...
      <div className={styles.item}>
        <div className={styles.img_wrapper}>
          <img draggable="false" alt="strato" src={fetchImage('/images/home/destino/destino_03.webp')} />
        </div>
      ...
      <div className={styles.item}>
        <div className={styles.img_wrapper}>
          <img draggable="false" alt="vector" src={fetchImage('/images/home/destino/destino_07.webp')} />
        </div>
      ...
      <div className={styles.item}>
        <div className={styles.img_wrapper}>
          <img draggable="false" alt="crown" src={fetchImage('/images/home/destino/destino_05.webp')} />
        </div>
      ...
      <div className={styles.item}>
        <div className={styles.img_wrapper}>
          <img draggable="false" alt="crown" src={fetchImage('/images/home/destino/destino_06.webp')} />
        </div>
